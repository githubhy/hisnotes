'use strict';(function(){const searchDataURL='/en.search-data.min.08804352d4aec8584272636421ff48890eea3c054c97f8ae27b45ba02dc42c72.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
